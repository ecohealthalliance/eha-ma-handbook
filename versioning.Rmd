...
-   Work through the online book [Happy Git with R](http://happygitwithr.com/), which will
    ...
    basic workflows.
-   Take the Data Camp course [Introduction to Git for Data Science](https://www.datacamp.com/courses/introduction-to-git-for-data-science) (free) to reinforce some key concepts and learn how work with versions on a day-to-day basis. 
...
-   Give [Noam](ross@ecohealthalliance.org) (Modeling & Analytics) or
    [Robert Young](young@ecohealthalliance.org) (Tech), your GitHub username so they can
