...
-   Work through the online book [Happy Git with R](http://happygitwithr.com/), which will
    ...
    basic workflows.
-   Take the Software Carpentries course [Version Control with Git](https://swcarpentry.github.io/git-novice/) (free) to reinforce some key concepts and learn how work with versions on a day-to-day basis. 
...
1) Set an expiration date - github will notify you about expirations
...
When your token is about to expire, you will get a notification from github. Thats
