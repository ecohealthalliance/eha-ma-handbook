...
At EHA _projects_ are typically months-to-years-long workstreams centered around
...
We organize projects into _work cycles_ of 4-8 weeks.  For each cycle, a team
...
-   Team assignments for the next cycle and level of involvement (high (>50%), medium (25%-50%, low (<25%)) of team memberss over the cycle.
...
-   Includes top-level summaries for a reporting
    period
...
version control.  In addition, it may have a Paperpile folder for references.
In general, one URL (often the GitHub README) should be the starting point from
...
-   Here is [a nice blog post about project structure](http://nicercode.github.io/blog/2013-05-17-organising-my-project/)
-   and a few more [alternatives](https://discuss.ropensci.org/t/resources-on-project-directory-organization/340).
-   For anything using R, [RStudio projects](https://support.rstudio.com/hc/en-us/articles/200526207-Using-Projects)
-   are a good idea for project organization. Here's a [Software Carpentry Lesson on RStudio projects](http://swcarpentry.github.io/r-novice-gapminder/02-project-intro/).
