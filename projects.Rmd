...
[Slides](https://ecohealthalliance.github.io/targets-example/outputs/targets-presentation.html#1),
[Example Repository on GitHub](https://github.com/ecohealthalliance/targets-example))
...
-   A good intro talk (\~90 mins with questions) by Miles McBain on
    using targets and getting a good workflow:
    <https://www.youtube.com/watch?v=jU1Zv21GvT4>

-   A great introductory video series: 5 30-minute lessons:
    <https://www.youtube.com/watch?v=pbc6NX1n01Q&list=PLvgdJdJDL-APJqHy5CXs6m4N7hUVp5rb4>
