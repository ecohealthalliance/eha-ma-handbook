...
2) [A section on ODK Collect](#collect), the Android-based mobile application used for offline data collection which interfaces with ODK Central 
...
<!-- Since this is a public document, is there any concern about spam or fishing by providing our emails? -->
...
<!-- Are there any common tasks we expect them to do with odk central? -->
...
<!-- Consider moving up this to the top since doing this out of order could cause an issue. It also may be good to provide an abbreviated list or diagram of the order of operations   -->
