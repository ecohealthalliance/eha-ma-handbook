...
1) Take a breath.
2) Make sure your sensitive files are included either in the `.gitattributes` file or your `.ignore` file. You can add a filter for particular files any where in your repo with `**/MySuperSensitiveFile` see [gitignore documentation](https://git-scm.com/docs/gitignore#_pattern_format)
