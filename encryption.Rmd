...
cat >> .attributes < **/.env filter=git-crypt diff=git-crypt

# may also be a good idea to add **/auth as well if you're going to be 
# using non-interactive processes with dropbox and google drive
cat >> .attributes < **/auth filter=git-crypt diff=git-crypt
