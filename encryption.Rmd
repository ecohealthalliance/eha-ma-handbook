...
making sure to use the section relevant to the architecutre and distribution 
information identified above.

**Note** Keybase is already installed on the EHA servers and only needs to be run via,
