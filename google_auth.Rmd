...
Basically, to acheive non-interactive auth we want to either provide a token directly or make a token discoverable. 
...
** add section on sodium **

#### Provide token to auth function



Point the `gs4_auth` function to the location of your file and 

**TODO**: expand to include git-crypt example and/or use of github secrets to store json in remote location.
