...
- Aegypti is a shared EHA resource, so good communication and responsible use are paramount to keeping everything running smoothly.
- We have a lot of RAM (256GB!), but in general, we need at least as much disk space free as RAM, as RStudio keeps temporary copies of your R session on-disk in case of a crash. We have a relatively small disk (1 TB), because it is a very high performance SSD.
    - This means that
