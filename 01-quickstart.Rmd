...
-   Download and install [Slack](https://slack.com/downloads/osx). If you don't
    alread have an invite, get one from Noam. Join the **\#r-discuss**,
    **\#stats-talk**, and **\#journal-club** channels and any others your
    supervisor suggests or are associated with projects you are assigned to.you
...
-   Install git and link it to RStudio and your GitHub account. Instructions for
    ...
    way don't hesitate to ask for help (via the **\#r-discuss** channel on
    Slack!).
