...
### Make a public/private PGP key pair
...
A good way to set up a widely-usaable and trusted key pair is to sign up
for [Keybase](https://keybase.io/), which lets you publish and therefore verify
the legitimacy of your public key through multiple accounts and devices. Sign
up for / install Keybase on your computer and verify your key through as many services as you use.

_Remember your Keypase passcode!_
...
### Create or import your Keybase keys 
...
your local keychain. Visit their Keybase profiles (e.g., <https://keybase.io/noamross>) and click on the key - it will show several ways to import 
...
system image, and to run these commands after the CI clones your repository:
