...
We have an **\#r-discuss** channel on Slack to ask questions and also news about
useful resources and packages. (There's also **\#python-discuss** and
**\#stats-chat**.) We prefer that you ask question on this channel rather than
...
-   There's an almost-monthly [NYC R Meetup](https://www.meetup.com/nyhackr/)
    and even rarer [Data Vizualization Meetup](https://www.meetup.com/DataVisualization/) that EHA members sometimes attend.
-   There's also an [R-Ladies NYC chapter](http://www.rladiesnyc.org/) that has
    ...
    support of machine learning and data science conferences. 
