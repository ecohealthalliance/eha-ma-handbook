...
1. Identify Funder DMP requirements and reach out to the `r params$data_librarian`
...
- Refine roles and tech stack
    - Will you need to control access to the data?
    - Who will be able to create and/or modify data elements?
...
- Link the plan to the objects being created via URI's.  
